...
resource "aws_iam_policy" "this" {
  name        = "lambda-vpc-dynamic-policy"
  description = "Lambda policy with dynamic DynamoDB & log ARNs"
    ...
    Statement = [
      ...
      },
      {
        ...
        Action = [
          ...
          "ec2:CreateTags", "ec2:CreateInternetGateway", "ec2:AttachInternetGateway",
          "ec2:DetachInternetGateway", "ec2:DeleteInternetGateway",
          "ec2:CreateRouteTable", "ec2:DeleteRouteTable", "ec2:CreateRoute",
          "ec2:CreateSubnet", "ec2:AssociateRouteTable", "ec2:DisassociateRouteTable",
          "ec2:DeleteSubnet", "ec2:DescribeRouteTables", "ec2:DescribeInternetGateways"
        ],
        Resource = "*"
      },
      {
